...
SELECT        
				...
				--Metricas Artificiales
				ISNULL(Ex_PedidosDetalles.PrecioUnd,0) *
				ISNULL(Ex_PedidosDetalles.Cantidad,0) AS _Vlr_Bruto, 
				
				ISNULL(Ex_PedidosDetalles.PrecioUnd,0) *
				ISNULL(Ex_PedidosDetalles.Cantidad,0) *
				ISNULL(Ex_PedidosDetalles.Descuento, 0) AS _Vlr_Dscto,
				
				(ISNULL(Ex_PedidosDetalles.PrecioUnd,0) *
				ISNULL(Ex_PedidosDetalles.Cantidad,0)) *
				(1-ISNULL(Ex_PedidosDetalles.Descuento, 0)) AS _Vlr_Neto,
